...
def suggest_outfit(new_item: dict, wardrobe: dict) -> str:
    ...
    if not wardrobe_items:
        prompt = (
            ...
            "They haven't shared their wardrobe. Give them 1-2 specific outfit ideas "
            "for this piece — mention what types of bottoms, shoes, and outerwear would "
            "work well. Be specific about silhouettes and vibes, not just generic advice. "
            "Keep it under 100 words and write in a helpful, casual tone."
        )
    else:
        wardrobe_text = "\n".join(
        ...
        prompt = (
            ...
            "pieces from their wardrobe. Reference the wardrobe items by name. Include "
            "styling notes (tucking, layering, etc.) and describe the overall vibe. "
            "Keep it under 120 words and write in a helpful, casual tone."
        )
    ...
    try:
        ...
        return f"Couldn't generate outfit suggestions right now — try again in a moment. ({e})"
...
def create_fit_card(outfit: str, new_item: dict) -> str:
    ...
    if not outfit or not outfit.strip():
        return "Can't create a fit card without an outfit suggestion — something went wrong in the previous step."

    client = _get_groq_client()

    prompt = (
        f"Write a casual, first-person Instagram/TikTok caption for this thrifted outfit.\n\n"
        ...
        "- Can include 1-2 emojis if they feel natural\n"
        "- Do NOT use hashtags\n"
    ...
    try:
        ...
        return "thrifted something good — details in my stories 🖤"
